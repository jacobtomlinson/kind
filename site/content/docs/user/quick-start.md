...
above you can install kind from source with `go install github.com/jacobtomlinson/kind@{{< stableVersion >}}` or clone this repo
...
To install use: `go install github.com/jacobtomlinson/kind@{{< stableVersion >}}`.
